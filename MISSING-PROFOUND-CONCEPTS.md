...
// Compare tunings
signal('equal', signal.tuning('equal').major(220));
signal('just', signal.tuning('just').major(220));
signal('pythagorean', signal.tuning('pythagorean').major(220));
