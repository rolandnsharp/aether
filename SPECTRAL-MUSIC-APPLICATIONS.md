...
signal('drone', spectralDrone(5).gain(0.2).fn);
```

### Example 2: Harmonic Arpeggiator

```javascript
signal('harmonic-arp', t => {
...
signal(t => Math.sin(2 * Math.PI * 440 * t))
